...
import { ResumoFormasPagamento } from './ResumoFormasPagamento'
  ...
  return (
    <div className="rounded-lg border bg-card p-4 space-y-3 shadow-sm">
      ...
      {isLoading || !data ? (
        ...
        <ResumoFormasPagamento data={data} rotuloRecebido={rotuloRecebido} rotuloQuantidade={rotuloQuantidade} rotuloDescontos={rotuloDescontos} />
      )}
    </div>
  )
}
